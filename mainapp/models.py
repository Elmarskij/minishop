...
class Cart(models.Model):
    ...
    total_price = models.DecimalField(max_digits=9, decimal_places=2, default=0, verbose_name='Общая цена')
...
class Customer(models.Model):
    ...
    phone = models.CharField(max_length=13, verbose_name='Номер телефона', null=True, blank=True)
...
class Order(models.Model):
    ...
    order_date = models.DateField(verbose_name='Дата получения закза', default=timezone.now)
